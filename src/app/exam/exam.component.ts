...
export class ExamComponent {
  ...
  @ViewChild(ExamchartComponent) examChartComponent : ExamchartComponent|undefined
  ...
  QandA=[
    {
      ...
      options: ["Managing and maintaining network infrastructure", "Developing mobile applications"],
    ...
    },
    {
      ...
      options: ["Hyper Text Markup Language", "High-level Text Machine Language"],
      
    },
    {
      qId:"question5",
      q: "What is the role of a cybersecurity analyst?",
      options: ["Protecting computer systems and networks from attacks", "Writing technical documentation"],
  ...
  sub=(data:any,form3:any)=>{
   ...
   // this.api.postExam()
     ...
     let count1=0,count2=0,count3=0,count4=0,count5=0
      ...
      if (data.question5=="Protecting computer systems and networks from attacks"){
        this.count+=1
        count5=1
      }
      
     this.api.postExam(JSON.stringify({q1:count1,q2:count2,q3:count3,q4:count4,q5:count5})).subscribe(res=>{
      console.log(res)
     },
     err=>{
      console.error(err)
